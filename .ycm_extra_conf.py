...
NodeMCU = "~/.platformio/packages/framework-arduinoespressif8266/variants/nodemcu"

#Platformio Arduino Std Libs
## Arduino Std libs from .platformio packages. Provides stdlib.h and such.
PlatformioArduinoSTD = '~/.platformio/packages/toolchain-xtensa/include'
StandardLib = "~/.platformio/packages/toolchain-xtensa/xtensa-lx106-elf/include"
DallasTemperature = "./.piolibdeps/DallasTemperature_ID54"
OneWire = "./.piolibdeps/OneWire_ID1"
